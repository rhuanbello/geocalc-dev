...
function RainfallStationImport({ latitudeText, longitudeText, coordinatesAreValid, point, station, distanceKm, hasManualAdjustments, onLatitudeChange, onLongitudeChange, onPointChange, onStationSelect, onMapExpand }: { latitudeText: string; longitudeText: string; coordinatesAreValid: boolean; point: MapPoint | null; station: InmetNormalStation | null; distanceKm: number | null; hasManualAdjustments: boolean; onLatitudeChange: (value: string) => void; onLongitudeChange: (value: string) => void; onPointChange: (point: MapPoint) => void; onStationSelect: (station: InmetNormalStation) => void; onMapExpand: () => void }) {
