  ...
  return <div className="app-layout">
    ...
    <main className="app-shell">
      ...
      <section className="panel eups-input-panel">
        ...
        <Guidance title="O que representa K">K expressa a suscetibilidade do solo à desagregação e ao transporte pela água. Selecione uma referência didática da planilha do Bida e informe ou revise o valor de K adotado.</Guidance>
