...
export const EUPS_METHODOLOGY: MethodologySection[] = [
  ...
  },
  {
    ...
    body: "Expressa a facilidade com que o solo pode ser desagregado e transportado pela água. A classificação guiada combina os componentes informados para a unidade de solo, seus pesos e a tabela de conversão de referência; um valor técnico específico também pode ser informado manualmente.",
